...
import {
  ...
  CharacterGridStyles,
  CharacterDescriptionWrapperStyles,
        ...
        <div sx={{ ...BookPageStyles, padding: "3rem 2.5rem 4rem 2.5rem" }}>
          ...
          <div sx={CharacterGridStyles}>
            <ul sx={CharacterInfoList}>
              ...
              <li sx={{ marginBottom: "0.25rem" }}>
                <b>Species:</b> {data.species ? data.species : "Unknown"}
              </li>
              <li sx={{ marginBottom: "0.25rem" }}>
                <b>Born:</b> {data.born ? data.born : "Unknown"}
              </li>
              {data.died && (
                <li sx={{ marginBottom: "0.25rem" }}>
                  <b>Died:</b> {data.died}
              ...
              <li sx={{ marginBottom: "0.25rem" }}>
                <b>Blood status:</b> {data.blood ? data.blood : "Unknown"}
              </li>
              <li sx={{ marginBottom: "0.25rem" }}>
                <b>Nationality:</b> {data.nationality ? data.nationality : "Unknown"}
              </li>
              <li sx={{ marginBottom: "0.25rem" }}>
                <b>Job:</b> {data.job ? data.job : "Unknown"}
              </li>
              {data.house && (
                <li sx={{ marginBottom: "0.25rem" }}>
                  <b>Hogwarts house:</b> {data.house}
                </li>
              )}
            </ul>
          ...
          <div sx={CharacterDescriptionWrapperStyles}>
            <div>
              ...
              >
                <li>
                  <b>Hair color:</b> {data.hair ? data.hair : "Unknown"}
                </li>
                <li>
                  <b>Eye color:</b> {data.eyes ? data.eyes : "Unknown"}
                </li>
                {data.height && (
                  <li>
            ...
            <div>
              ...
              >
                ...
                <li>
                  <b>Patronus:</b> {data.patronus ? data.patronus : "Unknown"}
                </li>
                {data.animagus && (
                  <li>
                    <b>Animagus:</b> {data.animagus}
                  </li>
                )}
              </ul>
            </div>
